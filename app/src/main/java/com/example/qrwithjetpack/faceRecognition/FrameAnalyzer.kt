...
import com.example.qrwithjetpack.faceRecognition.model.MaskDetectionModel
            ...
            for (face in faces) {
                try {
                    ...
                    if (maskLabel == maskDetectionModel.NO_MASK) {
                        ...
                        Log.e("FrameAnalyzer", "Average score for each user : $nameScoreHashmap" )
                        ...
                        Log.e("FrameAnalyzer","Person identified as $bestScoreUserName" )
                        predictions.add(
                            Prediction(
                                face.boundingBox,
                                bestScoreUserName ,
